...
const userIdStr = storedUserId ? storedUserId : '1';
const userId = parseInt(userIdStr, 10);

const response = await API.post('/donations/add', {  
    user_id: userId,  
...
return (
<div className="min-h-screen pt-8 pb-24 px-6 relative bg-[#F0F6FF] dark:bg-transparent transition-colors duration-500 font-['Inter',sans-serif]">
...
{/* Header */}  
      ...
      {steps.map((s, i) => (  
        <div key={s.num} className="flex items-center">  
          <div className="flex flex-col items-center gap-2 transition-all duration-300">  
            ...
            <span className={`text-xs font-bold uppercase tracking-wide ${step >= s.num ? 'text-gray-700 dark:text-gray-300' : 'text-gray-400'}`}>  
              {s.label}  
            </span>  
          </div>  
          {i < steps.length - 1 && (  
    ...
    <AnimatePresence mode="wait">  
      ...
      {step === 1 && (  
        ...
        >  
          {/* NGO Selector */}  
          <div className="bg-white dark:bg-[#111827] border border-[#3B82F6]/10 dark:border-white/10 rounded-3xl p-8 shadow-lg"  
            style={{ boxShadow: '0 8px 32px rgba(59,130,246,0.08), inset 0 1px 0 rgba(255,255,255,0.9)' }}>  
                ...
                <button  
                  ...
                  className={`flex items-center gap-4 p-4 rounded-2xl border text-left transition-all duration-200 group ${  
                    selectedNGO.id === ngo.id  
                      ...
                      : 'border-gray-200 dark:border-white/10 hover:border-[#3B82F6]/30 dark:hover:border-white/20 hover:bg-gray-50 dark:hover:bg-white/5'  
                  }`}  
                >  
                  ...
                  <div className="flex-1">  
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400">{ngo.category} • {ngo.impact}</div>  
                  </div>  
                  {selectedNGO.id === ngo.id && (  
          ...
          <div className="bg-white dark:bg-[#111827] border border-[#3B82F6]/10 dark:border-white/10 rounded-3xl p-8 shadow-lg"  
                ...
                <button  
                  ...
                  className={`py-3 rounded-xl font-bold text-sm border transition-all duration-200 hover:scale-[1.03] active:scale-[0.97] ${  
                    amount === a && !customAmount  
                      ...
                      : 'border-gray-200 dark:border-white/10 text-gray-700 dark:text-gray-300 hover:border-[#3B82F6]/40 bg-gray-50 dark:bg-white/5'  
                  }`}  
                >  
                  ₹{a.toLocaleString()}  
                </button>  
            ...
            <div className="relative">  
              ...
              <input  
                ...
                className="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-2xl pl-10 pr-5 py-4 text-gray-900 dark:text-white text-lg font-bold focus:outline-none focus:border-[#3B82F6] focus:ring-4 focus:ring-[#3B82F6]/10 transition-all placeholder-gray-300 dark:placeholder-gray-600"  
              />  
            </div>  
            ...
            {finalAmount > 0 && (  
              ...
              >  
                ...
                <div className="flex justify-between items-center text-sm mt-2">  
                  ...
                  <span className="font-medium text-gray-700 dark:text-gray-300">{selectedNGO.name}</span>  
                </div>  
              </motion.div>  
            )}  
          </div>  
      ...
      {step === 2 && (  
        <motion.div  
          ...
          className="space-y-6"  
        >  
          <div className="bg-white dark:bg-[#111827] border border-[#3B82F6]/10 dark:border-white/10 rounded-3xl p-8 shadow-lg space-y-6"  
            style={{ boxShadow: '0 8px 32px rgba(59,130,246,0.08), inset 0 1px 0 rgba(255,255,255,0.9)' }}>  
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2 font-['Clash_Display',sans-serif]">Review Your Donation</h2>  

            {/* Donation Summary */}  
            <div className="space-y-4 p-6 bg-gray-50 dark:bg-black/20 rounded-2xl border border-gray-100 dark:border-white/5">  
              {[  
            ...
            <div className="space-y-4">  
              ...
              <input  
                ...
                className="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl px-5 py-3.5 text-sm text-gray-900 dark:text-white placeholder-gray-400 outline-none focus:border-[#3B82F6] focus:ring-4 focus:ring-[#3B82F6]/10 transition-all"  
              />  
              <input  
                type="email"  
                  ...
                  <button  
                    ...
                    className={`p-4 rounded-xl border text-center transition-all text-sm font-bold ${  
                      paymentMethod === pm.key  
                        ? 'border-[#3B82F6] bg-[#3B82F6]/10 text-gray-900 dark:text-white shadow-[0_4px_12px_rgba(59,130,246,0.15)]'  
                        : 'border-gray-200 dark:border-white/10 text-gray-600 dark:text-gray-300 hover:border-gray-300 dark:hover:border-white/20 bg-gray-50 dark:bg-white/5'  
                    }`}  
                  >  
          ...
          <div className="flex gap-4">  
            <button  
              onClick={() => setStep(1)}  
              className="flex-1 py-4 rounded-2xl border border-gray-200 dark:border-white/10 text-gray-700 dark:text-white font-bold hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"  
            >  
              ← Back  
            </button>  
            <button  
            ...
            {isProcessing && (  
              ...
              >  
                <motion.div  
                  ...
                  className="bg-white dark:bg-[#111827] rounded-3xl p-10 max-w-sm w-full mx-6 text-center shadow-2xl border border-[#3B82F6]/15 dark:border-white/10"  
                >  
                      ...
                      <div className="space-y-2 mt-4 text-left">
                        {[
                          ...
                          <motion.div
                            ...
                            className="flex items-center gap-3 text-xs text-gray-600 dark:text-gray-400 font-mono py-2 border-b border-gray-100 dark:border-white/5"
                          >
          ...
          {step === 3 && (
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="bg-white dark:bg-[#111827] border border-[#3B82F6]/10 dark:border-white/10 rounded-3xl p-10 shadow-2xl text-center relative overflow-hidden"
                style={{ boxShadow: '0 20px 60px rgba(59,130,246,0.15), inset 0 1px 0 rgba(255,255,255,0.9)' }}>
                ...
                {/* Transaction Details */}
                <div className="bg-gray-50 dark:bg-black/30 rounded-2xl p-6 text-left space-y-4 border border-gray-100 dark:border-white/5 mb-6">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-500 dark:text-gray-400 text-sm">NGO</span>
                  ...
                  <div className="pt-4 border-t border-gray-200 dark:border-white/5">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">SHA-256 Security Verification Hash</span>
                    </div>
                    <div className="bg-gray-900 dark:bg-black/40 rounded-xl p-4 font-mono text-[#60A5FA] text-xs break-all leading-relaxed border border-[#3B82F6]/20 dark:border-white/5">
                      {successHash}
                    </div>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <button
                    onClick={handleReset}
                    className="w-full py-4 rounded-2xl border border-gray-200 dark:border-white/10 text-gray-600 dark:text-gray-400 font-bold hover:bg-gray-50 dark:hover:bg-white/5 transition-colors text-sm"
                  >
